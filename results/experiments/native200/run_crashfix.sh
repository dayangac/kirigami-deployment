...
#
#   nohup bash results/experiments/native200/run_crashfix.sh > results/experiments/native200/crashfix3600/run_all.log 2>&1 &
#
set -u
ROOT="$(cd "$(dirname "$0")/../../.." && pwd)"
cd "$ROOT"
OUT=results/experiments/native200/crashfix3600
