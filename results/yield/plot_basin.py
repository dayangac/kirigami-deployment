# WP2b figure. Reads results/yield/basin.csv (written by code/apps/kill_basin.cpp and
# merged by code/apps/kill_basin_agg.cpp) and writes results/yield/fig_basin.png.
