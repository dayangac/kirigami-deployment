...
#
#   julia --project=Kirigami Kirigami/apps/exp_a3_jitter.jl [--out DIR] [--shard S]
...
# them). Outputs go to results/experiments/jitter/.
...
function main(args::Vector{String})
    ...
    outdir = joinpath(REPO, "results", "experiments", "jitter")
