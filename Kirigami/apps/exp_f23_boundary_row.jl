...
#
#   julia --project=Kirigami Kirigami/apps/exp_f23_boundary_row.jl [--out DIR] [--limit K] [--regenerate]
#
...
# of them. Outputs go to results/experiments/f23/.
...
function main(args::Vector{String})
    ...
    outdir = joinpath(REPO, "results", "experiments", "f23")
    limit = typemax(Int)
    i = 1
    while i <= length(args)
        a = args[i]
