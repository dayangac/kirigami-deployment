...
#
#   julia --project=Kirigami Kirigami/apps/kill_k9c.jl [--n 200] [--maxf 800] [--out DIR]
...
function aggregate(outdir::String, nshards::Int)
    ...
    th_k9 = load_theta(joinpath(REPO, "results", "kill", "k9", "k9.csv"), "b_theta_exact")
    th_k9b = load_theta(joinpath(REPO, "results", "kill", "k9b", "k9b.csv"), "theta_exact")
    ...
    if !isempty(th_k9) && !isempty(th_k9b)
        ...
        print(so, "\nK9 / K9b cross-check (from results/kill/k9/k9.csv and k9b/k9b.csv):\n")
