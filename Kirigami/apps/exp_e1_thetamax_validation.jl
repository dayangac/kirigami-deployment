...
# (results/experiments/EXPERIMENTS.md, section K2a; 187 tightly embedded designs, all
...
#
#   (A) authored: exp_common's deployable_population(), called twice with a larger
...
#       copied from exp_k5_orientation / exp_a3_jitter -- not exposed by any header) at the
...
#   (C) the jitter ladder (ideas/round2_adversary.md Idea 4 / exp_a3_jitter) on the
...
#
# Sharding: --shard k --nshards n, exactly exp_a3_jitter's convention (every task whose
...
#
#   julia --project=Kirigami Kirigami/apps/exp_e1_thetamax_validation.jl [--shard S] [--nshards M] [--out DIR]
...
# ---------------------------------------------------------------------------
# K5's defect objective and greedy flip search (exp_k5_orientation / exp_a3_jitter). Semantics
...
# ---------------------------------------------------------------------------
# exp_a3_jitter's amplitude ladder and interior-vertex Gaussian jitter.
