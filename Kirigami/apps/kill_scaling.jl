...
# orientation rule the kill population uses (assign_orientation_relaxation, 4 restarts /
...
#                        the Eq. (6) projection X0. Caches X0/Phi through kill_common's
...
#
#   julia --project=Kirigami Kirigami/apps/kill_scaling.jl [--kind delaunay] [--sites 100]
...
function frozen_graph(kind::AbstractString, sites::Int, seed::Int)
    ...
    isfile(path) || error("kill_scaling: no corpus file $path")
