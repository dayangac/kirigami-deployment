...
#
#   julia --project=Kirigami Kirigami/apps/exp_t1_balance_defect.jl [--n 200] [--maxf 800] [--out DIR]
#         [--sigma DIR] [--cache DIR] [--mu-tol 1e-12] [--delta-tol 1e-9] [--limit K]
#         [--regenerate]
#
# Population as exp_k9_convex_embedding.jl (frozen k1a_200 + archived sigma_def; shared shape-cache
# layout). Outputs go to results/experiments/t1/.
...
function main(args::Vector{String})
    ...
    n = 200; maxf = 800
    outdir = joinpath(REPO, "results", "experiments", "t1")
    sigmadir = ""
    ...
    # The identical deterministic population index as exp_k6_zero_plus_repair: a graph counts only if
