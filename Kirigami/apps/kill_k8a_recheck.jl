...
#
# THE TEST. For each K9 design, regenerate variant (b) exactly as `kill_k9` does, then
...
#
#   julia --project=Kirigami Kirigami/apps/kill_k8a_recheck.jl [--n 200] [--maxf 800]
...
function main(args::Vector{String})
    ...
    for row in load_population("k1a_200")
        ...
        for which in 0:1
            ...
            # Variant (b), regenerated exactly as kill_k9 does it (same seeds, same three
