...
#
#   julia --project=Kirigami Kirigami/apps/kill_k8a.jl [--n 100] [--shard S] [--nshard M]
...
Base.@kwdef mutable struct Row
    ...
    euler_tested::Int = 0
    # --- recheck columns (results/kill/k8a/recheck.md) ---------------------------
...
function main(args::Vector{String})
    ...
    # control than the four tilings (kill_common::deployable_population, authored
