...
#
# THE HYPOTHESIS. Every experiment so far dies on the same
...
#
#   julia --project=Kirigami Kirigami/apps/exp_k9_convex_embedding.jl [--n 200] [--maxf 800] [--out DIR]
...
# The shape cache is results/experiments/k6/cache/<sigma>/.
# Outputs go to results/experiments/k9/.
...
function main(args::Vector{String})
    ...
    barrier_stages = 6
    outdir = joinpath(REPO, "results", "experiments", "k9")
    sigmadir = ""
