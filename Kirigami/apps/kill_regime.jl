...
#
#   julia --project=Kirigami Kirigami/apps/kill_regime.jl [--mode pop] [--out DIR]
...
# One native cell, run through the shared kill_native200 code path and then scored by the
