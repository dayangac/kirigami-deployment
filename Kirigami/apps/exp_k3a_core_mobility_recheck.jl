...
#
#   julia --project=Kirigami Kirigami/apps/exp_k3a_core_mobility_recheck.jl [--out DIR] [--maxf 1500]
#         [--limit K] [--regenerate]
#
# Outputs go to results/experiments/k3a/ by default.
...
function main(args::Vector{String})
    ...
    outdir = joinpath(REPO, "results", "experiments", "k3a")
    maxf = 1500
    limit = typemax(Int)
    i = 1
    while i <= length(args)
