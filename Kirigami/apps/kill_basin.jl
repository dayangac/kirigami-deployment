...
#
# Population: every row of results/kill/k9c/k9c.csv with theta_exact <= 1e-9 (93 designs),
...
#
#   julia --project=Kirigami Kirigami/apps/kill_basin.jl [--k9c PATH] [--sigma DIR]
