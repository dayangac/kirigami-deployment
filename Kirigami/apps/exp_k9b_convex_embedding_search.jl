...
#
#   julia --project=Kirigami Kirigami/apps/exp_k9b_convex_embedding_search.jl [--n 200] [--maxf 800] [--out DIR]
...
# earlier experiment used; 1e-9 is the one K9's audit showed to be free of the
...
function main(args::Vector{String})
    ...
    outdir = joinpath(REPO, "results", "experiments", "k9b")
    sigmadir = ""
